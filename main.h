...
int printc(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int prints(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int print_perc(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int print_int(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int printbi(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int printun(va_list types, char buffer[], int flags, int width,
		int precision, int size);
...
int printnon(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int printp(va_list types, char buffer[], int flags, int width,
		int precision, int size);
...
int printrev(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int printrot13(va_list types, char buffer[], int flags, int width,
		int precision, int size);
...
>> >> >> > 99dce2e82103d3560bf6200c1d5d6a6df586adb0
